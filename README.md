...
Fast, cross validated multiplication and table generation for Cayley–Dickson algebras up to **one million digit** element index tested for O(1)/O(n) and depend on RAM allocation up to 2^13 or more for table builder.
